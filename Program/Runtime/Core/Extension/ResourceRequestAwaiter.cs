...
{
    /// <summary>
    /// ResourceRequest クラスの拡張関数実装用構造体です
    /// </summary>
    public static class ResourceRequestExtension
    {
        ...
        /// <summary>
        /// ResourceRequestをFire And Forgetします。await可能だという警告を潰すことができます
        /// </summary>
        /// <param name="resourceRequest">Fire and Forgetする対象のResourceRequest</param>
        public static void Forget(this ResourceRequest resourceRequest)
        {
            // Fire And Forget
        }
    }
