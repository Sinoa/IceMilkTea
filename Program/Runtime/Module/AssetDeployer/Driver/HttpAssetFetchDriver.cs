...
{
    /// <summary>
    /// HTTPを用いたアセットフェッチドライバクラスです
    /// </summary>
    public class HttpAssetFetchDriver : AssetFetchDriver
    {
        // 定数定義
        ...
        /// <summary>
        /// HttpAssetFetchDriver クラスのインスタンスを初期化します
        /// </summary>
        ...
        /// <param name="bufferSize">ダウンロードバッファサイズ。既定は DefaultBufferSize です。</param>
        /// <exception cref="ArgumentNullException">assetUri が null です</exception>
        public HttpAssetFetchDriver(Uri assetUri, int bufferSize) : this(assetUri, bufferSize, DefaultTimeOutInterval)
        {
        }
        ...
        /// <exception cref="ArgumentNullException">assetUri が null です</exception>
        public HttpAssetFetchDriver(Uri assetUri, int bufferSize, int timeoutInterval)
        {
            // 初期化する
